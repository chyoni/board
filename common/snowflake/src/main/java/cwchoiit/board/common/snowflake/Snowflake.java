package cwchoiit.board.common.snowflake;
...
public class Snowflake {
	...
	private static final long maxNodeId = (1L << NODE_ID_BITS) - 1; // 1023
	private static final long maxSequence = (1L << SEQUENCE_BITS) - 1; // 4095
