...
public interface ArticleRepository extends JpaRepository<Article, Long> {
    ...
    List<Article> findAllInfinite(@Param("boardId") Long boardId, @Param("limit") Long limit);
    ...
    List<Article> findAllInfinite(@Param("boardId") Long boardId, @Param("limit") Long limit, @Param("lastArticleId") Long lastArticleId);
}