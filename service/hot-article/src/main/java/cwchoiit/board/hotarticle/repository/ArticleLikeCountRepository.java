...
public class ArticleLikeCountRepository {
    ...
    public void createOrUpdate(Long articleId, Long likeCount, Duration timeToLive) {
        redisTemplate.opsForValue().set(generateKey(articleId), String.valueOf(likeCount), timeToLive);
    }
